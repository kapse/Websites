...
<title>Admin Contact Buyer Page</title>
				...
				<%@ page import = "java.sql.*" %>
				    ...
				    ResultSet rs = null;
					    ...
					    try {
					    	...
					    	String sql="SELECT orderr.userId,buyer.firstname,buyer.lastname,buyer.email FROM orderr,buyer,product WHERE orderr.userId=buyer.userId AND orderr.p_id=product.p_id";					//    	String sql = "select * from seller where username='"+uname+"'";			
							...
							while (rs.next()) { %>
							<form name="Signupform" action="admincontactbuyer" method="post">
