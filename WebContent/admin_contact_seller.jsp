...
<title>Admin Contact Seller Page</title>
				...
				<%@ page import = "java.sql.*" %>
				    ...
				    ResultSet rs = null;
					    ...
					    try {
					    	...
					    	String sql="SELECT orderr.sellerId,seller.firstname,seller.lastname,seller.email FROM orderr,seller,product WHERE orderr.sellerId=seller.sellerId AND orderr.p_id=product.p_id";					//    	String sql = "select * from seller where username='"+uname+"'";			
							//		ResultSet rs=st.executeQuery(sql);
							rs=st.executeQuery(sql);
							%>
							<table border="1" style="width: 100%">
					        <caption><h3>Seller List</h3></caption>
					        <tr>
					        <td><input type="text" size="2" name="seller_id" value="admin_id" readonly></td>
					         <td><input type="text" size="2" name="user_id" value="Seller_id" readonly></td>									
							<td> <input type="text" size="8" name="p_size" value="Seller First Name" readonly></td>	
							<td> <input type="text" size="8" name="p_size" value="Seller Last Name" readonly></td>
							...
							while (rs.next()) { %>
							<form name="Signupform" action="admincontactseller" method="post">
							<table border="0" style="width: 100%">	
							<tr>							
							<td><input type="text" size="2" name="admin_id" value="<%=admin.getAdminId() %>" readonly></td>		
