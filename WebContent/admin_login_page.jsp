...
<div class="main">
	<div class="topheader">My Account | <a href="admin_login_page.jsp">Login</a></div>
	<div class="header">
	...
	<div class="aside"><br>
			<form name="Loginform" action="adminlogin" method="post">
				<table border="0" style="width: 100%">
					<caption><h2>ADMIN LOGIN PORTAL</h2></h2></caption>
					<tr>
						<th>UserName</th>
...
<% if(loggedIn.equalsIgnoreCase("true")) {%>
	 ...
	 <form name="Signup" action="admin.jsp" method="get">
			<table border="0" style="width: 100%">
			
				<tr>
					<th>You(admin) are already a loginned please Click to move your main page :</th>
