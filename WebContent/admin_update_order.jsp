				...
				<%@ page import = "java.sql.*" %>
				    ...
				    ResultSet rs = null;
					    ...
					    try {
					    	...
					    	String sql="SELECT orderr.order_id,orderr.shipping_address,orderr.order_status,orderr.quantity,buyer.firstname,buyer.lastname,buyer.phoneno,buyer.email,product.p_id,product.p_name,product.p_desc,product.p_size FROM orderr,buyer,product WHERE  orderr.userId=buyer.userId AND orderr.p_id=product.p_id";					//    	String sql = "select * from seller where username='"+uname+"'";			
							...
							while (rs.next()) { %>
							<form name="Signupform" action="admupdateorder" method="post">
