...
<div class="main">
	...
	<div class="aside"><br>
			<form name="Loginform" action="customerservice" method="post">
				<table border="0" style="width: 100%">
					<caption><h3>Fill the form and submit it , We will get back to you as soon as possible</h3></caption>
					<tr>
						<th>First Name</th>
					...
					<tr>
						<th>Description</th>
						<td><textarea rows="5" cols="20" name="comment" >
							</textarea></td>
					</tr>
					<tr>
	...
	<div class="aside"><br>
			<form name="Loginform" action="customerservice" method="post">
				<table border="0" style="width: 100%">
					...
					<tr>
						<th>Description</th>
						<td><textarea rows="5" cols="20" name="comment" required >
							</textarea></td>
					</tr>
					<tr>
						<th>Click button to submit</th>
