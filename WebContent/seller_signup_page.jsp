...
try{if(msg==null) msg="";}catch(NullPointerException e){response.sendRedirect("seller_signup_page.jsp");}
String loggedIn=(String)session.getAttribute("loggedIn");
try{if(loggedIn==null)loggedIn="";}catch(NullPointerException e){response.sendRedirect("seller_signup_page.jsp");}
...
<div class="main">
	...
	<div class="aside">
			<form name="Signupform" action="sellersignup" method="post">
				<table border="0" style="width: 100%">
					<caption><h2>SELLER SIGNUP PORTAL</h2></caption>
						<tr>
							<th></th>
	...
	<% if(loggedIn.equalsIgnoreCase("true")) {%>
	  ...
	  <form name="Signup" action="seller.jsp" method="get">
			<table border="0" style="width: 100%">
				...
				<tr>
					<th>You(seller) are already a member please Click to move your main page :</th>
